(function (root, factory) {
  ...
  const EXACT = new Map([
    ...
    ['No usable tennis players or teams were found. Check the sheet before publishing. The saved board was not changed.', 'We couldn’t find usable players or teams in that sheet. Check the data and try again — nothing was changed.'],
    ['Import cancelled. The live board was not changed.', 'Import canceled. Nothing changed.'],
  ...
  const STATUS_RULES = [
    ...
    [/^Import saved, but official ladder sync failed:\s*(.+)$/i, 'The import was saved, but the ladder didn’t finish updating: $1'],
